 ...
 *
 * The device does not support 64-bit addressing.
 *
 * BUGS:
...
xdump(Ctlr *ctlr, int doilock)
{
	...
	print("cmd %#ux sts %#ux fl %#lux ps1 %#ux ps2 %#ux frames[0] %#ux\n",
		INS(Cmd), INS(Status),
...
uhcimeminit(Ctlr *ctlr)
{
	...
	OUTS(Frnum, 0);
	dprint("uhci %#ux flb %#lux frno %#ux\n", ctlr->port,
...
init(Hci *hp)
{
	...
	dprint(" flb %#lux frno %#ux psc0 %#ux psc1 %#ux",
