...
extern u32int cprdtimerfreq(void);
extern u64int cprdtimerval(void);
...
extern void fbsetup(char*, uchar*, int);
extern uintptr farget(void);
...
extern void gpioselrp1(uint, int);
extern void gpiopulluprp1(uint);
extern void gpiopulloffrp1(uint);
extern void gpiopulldownrp1(uint);
extern void gpiooutrp1(uint, int);
extern int gpioinrp1(uint);
...
extern void mmuinit(ulong);
extern void mmuinit1(void);
extern void mmuinvalidate(void);
extern void mmuinvalidateaddr(uintptr);
